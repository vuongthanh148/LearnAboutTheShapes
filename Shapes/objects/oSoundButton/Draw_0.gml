...
/*for(i=0;i<4;i++){
	draw_text(60, i*50, string(global.data[i]));
}*/
...
draw_text(515 - (sprite_width*-1 + string_width(s0 + s )+ 34)/2 , y + 20 - string_height(s0 + s )/2 , s0 + s);
...
/*for(i = 0; i < 10; i += 1){
	...
	draw_text(50,200 + i*30,string(global.rightAnsIndex[i]));
}*/
